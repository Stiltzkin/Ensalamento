...
//		agenda.setData_inicio(diaFormater(agenda.getData_inicio()));
//		agenda.setData_fim(diaFormater(agenda.getData_fim()));
...
//	private int diaDaSemana(Date dia) {
...
//	}
//
//	private Date diaFormater(Date date) {
